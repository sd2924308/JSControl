<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/Users/yanglong/phpProject/JSControl/application/wechat/view/menu.index.html";i:1506619972;s:78:"/Users/yanglong/phpProject/JSControl/application/extra/view/admin.content.html";i:1506619972;}*/ ?>
<div class="ibox">
    ...
    <ul class='mobile-footer'>
        ...
        <li class="parent-menu">
            <a>
                ...
                <span data-type="<?php echo $menu['type']; ?>" data-content="<?php echo $menu['content']; ?>"><?php echo $menu['name']; ?></span>
            </a>
                ...
                <ul>
                    ...
                    <li>
                        <a class="bottom-border">
                            <span data-type="<?php echo $submenu['type']; ?>" data-content="<?php echo $submenu['content']; ?>"><?php echo $submenu['name']; ?></span>
                        </a>
                    </li>
                    <!--<?php endforeach; ?>-->
                    <!--<?php endif; ?>-->
