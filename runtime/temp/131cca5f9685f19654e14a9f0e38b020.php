<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/Users/yanglong/phpProject/JSControl/application/admin/view/config.file.html";i:1507276848;s:78:"/Users/yanglong/phpProject/JSControl/application/extra/view/admin.content.html";i:1506619972;}*/ ?>
<div class="ibox">
    ...
    <div class="form-group" data-storage-type="local">
        ...
        <div class='col-sm-8'>
            <input type="text" name="storage_local_exts" required="required"
                   ...
                   value="<?php echo sysconf('storage_local_exts'); ?>" class="layui-input">
    ...
    <div class="form-group" data-storage-type="qiniu">
        ...
        <div class='col-sm-8'>
            <input type="text" name="storage_qiniu_bucket" required="required"
                   ...
                   value="<?php echo sysconf('storage_qiniu_bucket'); ?>" class="layui-input">
    ...
    <div class="form-group" data-storage-type="qiniu">
        ...
        <div class='col-sm-8'>
            <input type="text" name="storage_qiniu_domain" required="required"
                   ...
                   value="<?php echo sysconf('storage_qiniu_domain'); ?>" class="layui-input">
    ...
    <div class="form-group" data-storage-type="qiniu">
        ...
        <div class='col-sm-8'>
            <input type="text" name="storage_qiniu_access_key" required="required"
                   ...
                   value="<?php echo sysconf('storage_qiniu_access_key'); ?>" class="layui-input">
    ...
    <div class="form-group" data-storage-type="qiniu">
        ...
        <div class='col-sm-8'>
            <input type="password" name="storage_qiniu_secret_key" required="required"
                   ...
                   value="<?php echo sysconf('storage_qiniu_secret_key'); ?>" maxlength="43" class="layui-input">
    ...
    <div class="form-group" data-storage-type="oss">
        ...
        <div class='col-sm-8'>
            <input type="text" name="storage_oss_bucket" required="required"
                   ...
                   value="<?php echo sysconf('storage_oss_bucket'); ?>" class="layui-input">
    ...
    <div class="form-group" data-storage-type="oss">
        ...
        <div class='col-sm-8'>
            <input type="text" name="storage_oss_domain" required="required"
                   ...
                   value="<?php echo sysconf('storage_oss_domain'); ?>" class="layui-input">
    ...
    <div class="form-group" data-storage-type="oss">
        ...
        <div class='col-sm-8'>
            <input type="text" name="storage_oss_keyid" required="required"
                   ...
                   value="<?php echo sysconf('storage_oss_keyid'); ?>" maxlength="16" class="layui-input">
    ...
    <div class="form-group" data-storage-type="oss">
        ...
        <div class='col-sm-8'>
            <input type="password" name="storage_oss_secret" required="required"
                   ...
                   value="<?php echo sysconf('storage_oss_secret'); ?>" maxlength="30" class="layui-input">
