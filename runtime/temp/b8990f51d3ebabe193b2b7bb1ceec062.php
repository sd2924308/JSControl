<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/Users/yanglong/phpProject/JSControl/application/wechat/view/fans.index.html";i:1506619972;s:78:"/Users/yanglong/phpProject/JSControl/application/extra/view/admin.content.html";i:1506619972;}*/ ?>
<div class="ibox">
...
<div class="nowrap pull-right" style="margin-top:10px;margin-right:10px">
    <button data-update="" data-action="<?php echo url('backadd'); ?>" class='layui-btn layui-btn-small'>移入黑名单</button>
</div>
    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class='text-left'><?php echo $vo['sex']==1?'男':($vo['sex']==2?'女':'未知'); ?></td>
                <td>
                    <span>
