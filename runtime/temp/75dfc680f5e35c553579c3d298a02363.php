<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/Users/yanglong/phpProject/JSControl/application/wechat/view/keys.index.html";i:1506619972;s:78:"/Users/yanglong/phpProject/JSControl/application/extra/view/admin.content.html";i:1506619972;}*/ ?>
<div class="ibox">
...
<form onsubmit="return false;" data-auto="true" action="__SELF__" method="post">
    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-left">
                    <?php if(!empty($vo['qrc'])): ?>
                    <i class="fa fa-qrcode fa-lg pointer" data-tips-image="<?php echo $vo['qrc']; ?>" data-tips-text="关键字二维码"></i>
                    <?php endif; ?>
                    <?php echo $vo['keys']; ?>
                </td>
                ...
                <td class='text-center nowrap'>
                    ...
                    <span class="text-explode">|</span>
                    <a data-update="<?php echo $vo['id']; ?>" data-field='delete' data-action='<?php echo url("del"); ?>'
    ...
    <?php if(isset($page)): ?><p><?php echo $page; ?></p><?php endif; else: ?>
