<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/Users/yanglong/phpProject/JSControl/application/wechat/view/review.index.html";i:1506619972;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <title></title>
            ...
            <div class="aui-chat-item aui-chat-left">
                ...
                <div class="aui-chat-inner">
                    ...
                    <div class="aui-chat-content bg-white">
                        <div class="aui-chat-arrow one"></div>
                        <div class="aui-chat-arrow two"></div>
                        <img src='<?php echo (isset($content) && ($content !== '')?$content:"__STATIC__/theme/default/img/image.png"); ?>'/>
                    </div>
